                ...
                <section id='contact' className="text-gray-600 body-font relative bg-white">
                    <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
                        ...
                        <div className="mx-auto max-w-2xl text-center">
                            <h2 className="text-balance text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl font-heading capitalize">Get in touch with us</h2>
                        ...
                        <form action="#" method="" className="mx-auto mt-16 max-w-xl sm:mt-20">
                                ...
                                <div>
                                    ...
                                    <div className="mt-2.5">
                                        <input
                                            ...
                                            className="block w-full rounded-md bg-white px-3.5 py-2 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-secondary"
                                        />
                                    </div>
                                </div>
                                <div>
                            ...
                            <div className="mt-10">
                                <button
                                    type="submit"
                                    className="block w-full rounded-md bg-secondary px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-secondary-light focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-secondary"
                                >
                                    Let's talk
                                </button>
                            </div>
